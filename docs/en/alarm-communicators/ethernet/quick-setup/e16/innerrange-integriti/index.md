# Innerrange Integriti with E16 quick setup

Short steps to connect the E16 communicator to an Innerrange Integriti panel, configure E16 for IP reporting, and add the system to Protegus2. Use this together with the full E16 manual for all other settings.
...
- Innerrange Integriti panel with firmware version **19.1.0.36608** or higher.
- Innerrange professional software version **19.1.0.15396** or higher.
- Inner Range cable, part number `INTG-996795`.
...
| E16 terminal | Innerrange Integriti panel | Notes |
| --- | --- | --- |
| `+DC` | `+DET` | `+13V` supply |
| `-DC` | `GND 5` | TTL Port-0 ground |
| `CLK` | `Rx 3` | TTL Port-0 |
| `DATA` | `Tx 2` | TTL Port-0 |

<img alt="E16 Innerrange Integriti panel connection diagram" src="../images/innerrange-integriti.webp" style="width:5.2in;max-width:100%;height:auto;" />
...
4. Configure the panel port connected to E16 as **TTL Port-0** with settings **19200, 8, N, 1**.
