...
Radio receivers are applied as a component part of the radio protection system RAS-3 and are designed for reception and decoding of encoded messages sent via radio communication channel at VHF (R11) or UHF (R11U) frequency band.

Signals sent via the encoding system RAS-3 are received and decoded by the receivers.

<img alt="" src="./image2.jpeg" style="width:3.90625in;height:2.2708333333333335in" />
...
4\. Sensitivity of the receivers R11, R11U is not less than 1 μV, at adequately received message number 80%. Other radio-technical parameters are specified in Table No. 1.

5\. The receiver measures the strength of signal received and attributes it to a certain level. Level and signal conformity is specified in Table No. 2.
...
7\. Receiver has two inputs designated for independent message sending. Type of inputs
...
| 6 | 16,85 | -83 | E | 630 | -51 |
| 7 | 25 | -79 | F | 1000 | -47 |
| Note: These levels differ from the table of levels in RAS-2M system! |  |  |  |  |  |

> ![](./image4.jpeg)**General view and connection layout**
>
...
> ![](./image6.jpeg)USB port RESET
>
> button
>
> \* Designation of MCI bus contact terminals is indicated in Table No. 3
...
> **Light indication**
>
> Receiver operation is shown by light indication. Operation of light indicators is specified in Table No. 4.
>
> <img alt="" src="./image7.jpeg" style="width:2.7395833333333335in;height:0.9479166666666666in" />
...
>
> ![](./image10.png)1. Enter Admin password 1234 using the computer keyboard and click [Enter]
>
> At the bottom of the window are displayed:
>
> equipment type Device,
>
> serial number SN, boot loader version BL ver.
>
...
>
> <img alt="" src="./image11.png" style="width:1.2631944444444445in;height:1.301388888888889in" /><img alt="" src="./image12.png" style="width:3.3020833333333335in;height:2.2395833333333335in" /> USB port settings in the column Settings
>
...
> ATTACHMENT A
>
> **Receiver output signal in the serial port RS232**
>
> a\) when the following Monas3 output protocol is set
>
> TD1001017\_\*\*\*010532_3D025218_E13002027_120514/153241
>
> where:
>
> TD – symbol of start
...
> R11 event code
>
> 1401FFFF12345601001234\*\*\*\*\*\*\*\*0330199000 where:

| 1234 | object number | 8191 |
|------|---------------|------|
| 03   | event/restore |      |
| 301  | event code    |      |
| 99   | subgroup      |      |
...
| Event | RAS-3D change into | ECID | Note |
|-------|--------------------|------|------|
...
| Hight RF Noise | 0135599000 | E355 99 000 | send |
...
| Transmitter PING |  | E770 99 00X | where: x – next PING period do not send |
