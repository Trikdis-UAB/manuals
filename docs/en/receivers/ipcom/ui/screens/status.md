...
- `Left block` shows the logout control, current user identity, and connected host, used to confirm you are operating in the intended environment and account.  
  ![Status tab footer left block](../assets/screens/status-sections/footer-left.webp)
- `Center block` shows supervision counters (`Total objects`, `Online`, `SMS mode`, `Offline`, `Untracked`) for fast before/after change validation.  
  ![Status tab footer center block](../assets/screens/status-sections/footer-center.webp)
- `Right block` shows `IPCCw Build` and the live connection indicator to validate running build and UI transport state.  
  ![Status tab footer right block](../assets/screens/status-sections/footer-right.webp)
...
![Status tab General section](../assets/screens/status-sections/general.webp)
...
![Status tab API section](../assets/screens/status-sections/api.webp)
...
![Status tab TCP Connections section](../assets/screens/status-sections/tcp-connections.webp)
...
![Status tab Output buffers section](../assets/screens/status-sections/output-buffers.webp)
...
<img src="../../assets/screens/status-sections/device-tracker.webp" alt="Status tab Device Tracker section" width="560" />
...
![Status tab Database section](../assets/screens/status-sections/database.webp)
...
<img src="../../assets/screens/status-sections/modem-status.webp" alt="Status tab Modem status section" width="560" />
...
<img src="../../assets/screens/status-sections/connected-users.webp" alt="Status tab Connected users section" width="560" />
