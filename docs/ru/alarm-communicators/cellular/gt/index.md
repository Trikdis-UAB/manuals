...
| Клемма | Описание |
|--------|----------|
| +12 VDC | Клемма подключения питания (10-18 В постоянного тока, положительная клемма) |
| -12 VDC | Клемма подключения питания (0 В постоянного тока, отрицательная клемма) |
