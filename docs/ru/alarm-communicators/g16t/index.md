...
| Индикатор | Статус | Описание | NETWORK / (Сеть) | Выключен<br>Мигает желтым<br>Светит зеленым и мигает желтым | Нет подключения с GSM сетью.<br>Идет подключение к GSM сети.<br>Коммуникатор подключен к GSM сети. Достаточный уровень сигнала в сети 2G является 5 уровень (5 вспышек индикатора желтым цветом), в 3G сети – 3 уровень (3 вспышки индикатора желтым цветом). | DATA / (Данные) | Выключен<br>Зеленый<br>Мигает зеленый | Нет неотправленных сообщений.<br>Есть неотправленные сообщения.<br>(режим конфигурации) перенос данных в коммуникатор или из него. | POWER (Электропитание) | Выключен<br>Зеленый<br>Желтый<br>Светит зеленым и мигает желтым<br>Желтый | Нет напряжения питания.<br>Хороший уровень питающего напряжения<br>Низкий уровень питающего напряжения (≤11.5 В).<br>(режим конфигурации) коммуникатор подготовлен к конфигурации.<br>(режим конфигурации) нет связи с компьютером. | TROUBLE (Неисправность) | Выключен<br>1 вспышка красным<br>2 вспышки красным<br>3 вспышки красным<br>4 вспышки красным<br>5 вспышек красным<br>6 вспышек красным<br>7 вспышек красным<br>Мигает красным<br>Красный | Нет неисправностей<br>Нет SIM карты<br>Неправильный PIN код SIM карты.<br>Проблемы программирования (нет APN).<br>Проблемы с подключением к GSM сети.<br>Проблемы с подключением к сети мобильного интернета<br>Нет связи с приемником<br>Пропала связь с охранной панелью<br>(режим конфигурации) ошибка памяти<br>(режим конфигурации) ошибка программного обеспечения |
|-----------|--------|----------|------------------|-------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|------------------------|---------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
