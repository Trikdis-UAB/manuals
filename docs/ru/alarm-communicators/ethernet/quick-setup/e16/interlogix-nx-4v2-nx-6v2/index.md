# Interlogix NX-4v2 / NX-6v2 с E16 быстрая настройка

Краткие шаги по подключению коммуникатора E16 к панелям Interlogix NX-4v2 / NX-6v2, настройке E16 для передачи по IP и добавлению системы в Protegus2. Используйте эту инструкцию вместе с полным руководством E16 для остальных настроек.
...
<img alt="Схема подключения E16 Interlogix" src="../images/caddx.webp" style="width:5.2in;max-width:100%;height:auto;" />
