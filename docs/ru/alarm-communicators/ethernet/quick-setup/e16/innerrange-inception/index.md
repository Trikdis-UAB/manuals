# Innerrange Inception с E16 быстрая настройка

Краткие шаги по подключению коммуникатора E16 к панели Innerrange Inception, настройке E16 для передачи по IP и добавлению системы в Protegus2. Используйте эту инструкцию вместе с полным руководством E16 для остальных настроек.
...
<img alt="Схема подключения E16 Innerrange Inception" src="../images/innerrange-inception.webp" style="width:5.2in;max-width:100%;height:auto;" />
...
![Настройки отчетов Innerrange Inception](../../../../e16/image21.webp)
...
1. Если вместо прямого управления используется ключевая зона, подключите `I/O 1` к ключевой зоне панели и настройте область в Protegus2 с `PGM1` в режиме **Pulse** или **Level**.
1. Дождитесь, пока система отобразится в сети.

## Проверка системы

1. Поставьте и снимите систему с охраны с клавиатуры или пользовательского интерфейса.
1. Сымитируйте тестовую тревогу.
