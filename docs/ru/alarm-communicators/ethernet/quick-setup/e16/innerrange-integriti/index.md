# Innerrange Integriti с E16 быстрая настройка

Краткие шаги по подключению коммуникатора E16 к панели Innerrange Integriti, настройке E16 для передачи по IP и добавлению системы в Protegus2. Используйте эту инструкцию вместе с полным руководством E16 для остальных настроек.
...
<img alt="Схема подключения E16 Innerrange Integriti" src="../images/innerrange-integriti.webp" style="width:5.2in;max-width:100%;height:auto;" />
