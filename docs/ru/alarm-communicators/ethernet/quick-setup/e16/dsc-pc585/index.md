# DSC PowerSeries с E16 быстрая настройка

Краткие шаги по подключению коммуникатора E16 к панелям DSC PowerSeries (PC585, PC1404, PC1565, PC1616, PC1832, PC1864, PC5020), настройке E16 для передачи по IP и добавлению системы в Protegus2. Используйте эту инструкцию вместе с полным руководством E16 для остальных настроек.
...
<img alt="Схема подключения E16 DSC" src="../images/dsc.webp" style="width:5.2in;max-width:100%;height:auto;" />

## Программирование охранной панели

Для работы E16 дополнительное программирование панелей DSC не требуется.
