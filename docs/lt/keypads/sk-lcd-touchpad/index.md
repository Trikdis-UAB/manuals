...
> [!NOTE]
> Signalizacijos valdymo klaviatūra „SK-LCD TouchPad“ užtikrina **64 zonų ir 8 sričių** atvaizdavimą. Taip pat klaviatūra „SK-LCD TouchPad“ gali būti priskirta valdyti vieną ar kelias norimas sritis (klaviatūros programinės įrangos versija nuo FW:1.41, centralės programinės įrangos versija nuo FW:SP3_xxx4_0119). Klaviatūroje bus atvaizduojamos priskirtos srities ir srities zonų būsenos.
...
6. Išeikite iš patalpų per išėjimui skirtą **Exit Delay** laiko atskaitą.
...
### Signalizacijos išjungimas (DISARM)
...
Kai signalizacija išjungta, klaviatūros ekrane atsiras tekstas: **Išjungta: Sritis**.
