...
1.  Surinkite signalizacijos valdymo kodą. Indikatorius [**BYP**] pradės mirksėti.

**<u>BYPASS funkcijos išjungimas:</u>**

Pakartokite tuos pačius veiksmus, kaip ir išjungiant konkrečios zonos stebėjimą.

1.  Pasirinkite norimą zonų būsenų indikacijos apšvietimo ryškumą mygtukais [**1**] ir [**4**].
...
1.  Surinkite *Master* kodą, numatytasis – 1234. Pradės šviesti zonų indikatoriai, rodantys eilės numerius tų vartotojų, kurių kodai jau įvesti.
