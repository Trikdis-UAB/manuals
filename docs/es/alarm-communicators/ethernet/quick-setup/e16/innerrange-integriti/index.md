# Innerrange Integriti con E16 configuración rápida

Pasos breves para conectar el comunicador E16 a un panel Innerrange Integriti, configurar E16 para reportes IP y añadir el sistema a Protegus2. Utilice esta guía junto con el manual completo de E16 para el resto de los ajustes.
...
<img alt="Diagrama de conexión E16 Innerrange Integriti" src="../images/innerrange-integriti.webp" style="width:5.2in;max-width:100%;height:auto;" />
