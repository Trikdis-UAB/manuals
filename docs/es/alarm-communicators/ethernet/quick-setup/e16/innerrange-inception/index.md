# Innerrange Inception con E16 configuración rápida

Pasos breves para conectar el comunicador E16 a un panel Innerrange Inception, configurar E16 para reportes IP y añadir el sistema a Protegus2. Utilice esta guía junto con el manual completo de E16 para el resto de los ajustes.
...
<img alt="Diagrama de conexión E16 Innerrange Inception" src="../images/innerrange-inception.webp" style="width:5.2in;max-width:100%;height:auto;" />
...
![Ajustes de reporte Innerrange Inception](../../../../e16/image21.webp)
...
1. Arme y desarme el sistema desde el teclado o desde la interfaz de usuario.
1. Genere una alarma de prueba.
